...
class MATF_Disc(MATF):
    ...
    def forward(self, agents_traj, agents_traj_len, episode_idx, future_agent_masks, decode_start_pos, scene_images,
                num_candidate=1):
        agent_encodings = self.encoder(agents_traj, agents_traj_len, decode_start_pos, episode_idx, future_agent_masks,
                                       scene_images, num_candidate)
